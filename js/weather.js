...
(function(){
	...
	var weatherData;
    // 로드한 데이터를 insertData() 함수에서 접근해야 하기 때문에 함수 안에 선언하지 않고,
    // 함수 바깥쪽에 전역변수로 선언하여 insertData() 함수에서 접근할 수 있도록 함.
	...
	function insertData(){
        ...
        var iconRoot = 'images/weather_icon/';
        // 예제에 들어갈 아이콘 이미지의 폴더 주소를 미리 변수에 할당
        var bgRoot = 'images/weather_bg/';
